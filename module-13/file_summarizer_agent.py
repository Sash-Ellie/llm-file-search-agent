...
class FileSummarizerAgentConfig(lr.ChatAgentConfig):
    ...
    TODO: Write your system message here
    """
...
file_summarizer_agent = None  # Replace with configured agent instance
